...
const HARDCODED_URLS = {
  ...
  VENDAS_B2B: 'https://docs.google.com/spreadsheets/d/1ow27Z_n7Kl4qwnBdbdMi44LK_il7kck0uCmjwankEDI/edit',
  CUSTOMER_CARE: '',
  ...
  return [
    ...
    },
    {
      ...
      columns: [
        ...
        { internal: 'celular', external: 'celular' },
        { internal: 'data_venda', external: 'data_venda' },
        { internal: 'ultima_parcela', external: 'ultima parcela' },
        { internal: 'forma_pagamento', external: 'forma' },
        { internal: 'desconto', external: 'desconto' },
        { internal: 'duracao_curso', external: 'duracao_curso' },
    ...
    },
    {
      ...
      sheetName: 'Alunos',
      columns: [
        { internal: 'aluno_id', external: 'cpf/cnpj' },
        { internal: 'aluno_nome', external: 'NOME' },
        { internal: 'email', external: 'EMAIL' },
        { internal: 'produto', external: 'PRODUTO' },
    ...
    },
    {
      ...
      columns: [
        ...
        { internal: 'data_levelling', external: 'Obs1' },
        { internal: 'nivel', external: 'NIVEL' },
        { internal: 'acesso', external: 'ACESSO' },
        { internal: 'data_acesso', external: 'Obs2' },
        { internal: 'onboarding', external: 'ONBOARDING' },
        { internal: 'data_onboarding', external: 'Obs3' },
        { internal: 'primeira_aula', external: '1 AULA' },
        { internal: 'data_primeira_aula', external: 'DATA 1 AULA' },
        { internal: 'data_fup1', external: '1 FUP(7 dias)' },
        { internal: 'status_fup1', external: 'Status 1' },
        { internal: 'data_fup2', external: '2 FUP (30 dias)' },
        { internal: 'status_fup2', external: 'Status 2' },
        { internal: 'renovacao', external: 'RENOVAÇÃO' },
        { internal: 'status_3', external: 'Status 3' },
        { internal: 'obs4', external: 'Obs 4:' },
      ],
    },
    {
      id: 'marketing',
